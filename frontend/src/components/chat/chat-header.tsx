    ...
    <>
      <div className="flex items-center justify-between px-4 py-2 border-b">
        ...
        <div className="flex items-center gap-2">
          {session?.title !== "Owner" && (
            <button
              className="px-3 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg flex items-center gap-1.5 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-indigo-600"
              disabled
              title="Coming soon"
            >
              <svg
